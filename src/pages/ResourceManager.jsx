 ...
 */
export default function ResourceManager({ title, subtitle, api, columns, emptyItem }) {
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {loading ? (
                ...
                items.map((item) => (
                  <tr key={item.id} className="border-b border-slate-50 dark:border-white/[0.04] last:border-0">
                    {columns.map((c) => (
